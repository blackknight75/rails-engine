...
describe 'merchants', type: :request do
  ...
  it 'returns nil if seach by invalid name' do
    merchants = create_list(:merchant, 2)

    get "/api/v1/merchants/find?name=gdfklhjskdgjhfskdjhlfg"
  ...
  it 'returns nil if find all by invalid name' do
    merchants = create_list(:merchant, 5)

    get "/api/v1/merchants/find_all?name=fkhjdsakahjldfskjhafsd"
